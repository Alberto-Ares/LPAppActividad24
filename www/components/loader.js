...
;
    ...
    document.addEventListener('deviceready', function(){
        window.monaca.isDeviceReady = true;
        // monaca.apiQueue.next();
        // document.getElementById('texto').innerHTML= 'DISPOSITIVO CONECTADO';
    }, false);
...
function btnpropiedades() {
    var lista = "";
    lista += "<li><b>Fabricante:</b> " + device.manufacturer + "</li>";
    lista += "<li><b>Modelo:</b> " + device.model + "</li>";
    lista += "<li><b>Sistema Operativo:</b> " + device.platform + "</li>";
    lista += "<li><b>Version S.O.:</b> " + device.version + "</li>";
    lista += "<li><b>Tfno IMEI:</b> " + device.uuid + "</li>";
    lista += "<li><b>Tfno Nº Serie:</b> " + device.serial + "</li>";
    lista += "<li><b>Version Plugin:</b> " + device.cordova + "</li>";
    document.getElementById("propiedades").innerHTML = lista;
}
